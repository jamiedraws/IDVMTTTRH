<%@ Page Language="C#" MasterPageFile="~/VersionViews/4.0000/Views/Layouts/InternalLayout.master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    %>
    <main aria-labelledby="search-results-title" class="view product product--grid section">
        <div id="search-results" class="view__anchor"></div>
        <div class="view__in section__in">
            <div class="content content--title-desc"> 
                <h2 id="search-results-title" class="title">Shop <%= SettingsManager.ContextSettings["Label.ProductName"] %></h2>
                <%
            ...
            <form class="form">
                <div class="story-card story-card--max-three">
                    <div id="search-results-group" class="story-card__group product ">
                        <%
