        ...
        <div class="story-card__buttons">
            <%if (!isExternal)
                { %>
                    ...
                    <a href="javascript:void(0);" data-code-toggle="true" data-select-id="<%=plpQtyId %>_Select" data-code="<%=p.ProductCode %>"  data-qty-id="<%= qtyId %>" class="button button--order delay-input delay-input--shopping-cart" id="addToCartButton">Add To Cart</a>
